...
async function main() {
    await test('europe-west4', 'deepseek-ai/deepseek-r1');
    await test('europe-west4', 'deepseek-ai/deepseek-v3.2-maas');
    await test('global', 'deepseek-ai/deepseek-r1-maas'); // Just in case
    await test('us-central1', 'deepseek-ai/deepseek-r1-maas'); // Just in case
}
