      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="space-y-6 text-white/80 leading-relaxed">
          <p>
            ...
            between you and Apple Juice AI.
          </p>
          ...
          <p>
            Apple Juice AI grants you a revocable, non-exclusive,
          ...
          <p>
            The Apple Juice plugin interfaces with Roblox Studio. You agree that
            Apple Juice AI is not affiliated with Roblox Corporation, and you
            will use the tool in compliance with Roblox's Terms of Use.
          </p>
          ...
          <p>
            ...
            maximum extent permitted under applicable law, Apple Juice AI
