    ...
    <div className="min-h-screen bg-[#05050a] text-white px-6 py-20 lg:py-32 font-sans">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-14 text-white/70 leading-relaxed text-[15px]">
          ...
          <section>
            <p>
              Apple Juice (&ldquo;we&rdquo;, &ldquo;us&rdquo;,
              &ldquo;our&rdquo;) is an independent, open-source developer tool.
              This Privacy Policy explains what information we collect, how we
              use it, and the rights you have over that information.
            </p>
            <p className="mt-4">
              By using Apple Juice you agree to the practices described below.
          ...
          <section>
            ...
            <p>
              ...
              <strong className="text-white">
                official Roblox OAuth 2.0 authorization flow
              </strong>
              —a publicly available developer program provided by Roblox
              Corporation. The authorization screen you see during sign-in is
              hosted at{" "}
              <code className="text-white/60 bg-white/5 px-1.5 py-0.5 rounded text-sm">
                roblox.com
              </code>{" "}
              and is operated entirely by Roblox.
            </p>
            <ul className="mt-5 space-y-3 list-none">
              <li className="flex items-start gap-3">
                <span className="text-[#ccff00] font-bold mt-0.5 flex-shrink-0">
                  →
                </span>
                <span>
                  Roblox shares your User ID and public profile data with us,
                  exactly as displayed on the OAuth consent screen.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#ccff00] font-bold mt-0.5 flex-shrink-0">
                ...
                <span>
                  We store your User ID and display name in an encrypted
                  server-side session to keep you logged in.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#ccff00] font-bold mt-0.5 flex-shrink-0">
                ...
                <span>
                  We NEVER receive, store, or transmit your Roblox account
                  password.
                </span>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span>
                  We NEVER receive your Robux balance, purchase history,
                  inventory, or any financial data.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-[#ccff00] font-bold mt-0.5 flex-shrink-0">
                ...
                <span>
                  You may revoke Apple Juice&apos;s access at any time from your
                  Roblox account settings under &ldquo;Connected Apps&rdquo;.
                  Revocation immediately invalidates your Apple Juice session.
                </span>
              </li>
            </ul>
            <p className="mt-5">
              OAuth tokens are held in encrypted, short-lived server-side
              sessions and are never exposed to third parties.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Apple Juice supports user-supplied API keys for OpenAI and Google
              AI Studio.
            </p>
            <ul className="mt-5 space-y-3 list-none">
              {[
            ...
            <p className="mt-5">
              If you use the platform&apos;s shared credit pool, your prompts
              are processed via our server-side integration. In this case,
              prompt text is transmitted to the AI provider through our server
              but is{" "}
              <strong className="text-white">not stored or logged</strong>{" "}
          ...
          <section>
            ...
            <p className="mb-6 text-sm">
              Two separate paths exist. Your{" "}
              <strong className="text-white">API key</strong> never crosses the
              server boundary. Only your{" "}
              <strong className="text-white">prompt context</strong> is proxied
              — and only when using the shared credit pool.
            </p>
            ...
            <div className="rounded-2xl border border-white/10 bg-[#080809] p-6 sm:p-8 font-mono text-sm overflow-x-auto">
              ...
              <p className="text-[10px] tracking-[0.2em] uppercase font-bold text-[#ccff00] mb-4">
                Path A — Personal API Key (Your Key)
              </p>
              <div className="flex items-center flex-wrap gap-0">
                <div className="flex flex-col items-center">
                  <div className="px-4 py-2.5 rounded-xl border border-white/20 bg-white/5 text-white text-xs font-semibold whitespace-nowrap">
                    Your Browser
                  </div>
                ...
                <div className="flex flex-col items-center">
                  <div className="px-4 py-2.5 rounded-xl border border-[#ccff00]/30 bg-[#ccff00]/5 text-[#ccff00] text-xs font-semibold whitespace-nowrap">
                    OpenAI / Google
                  </div>
              ...
              <p className="text-[10px] tracking-[0.2em] uppercase font-bold text-blue-400 mb-4">
                Path B — Shared Credit Pool (No Personal Key)
              </p>
              <div className="flex items-center flex-wrap gap-0">
                <div className="flex flex-col items-center">
                  <div className="px-4 py-2.5 rounded-xl border border-white/20 bg-white/5 text-white text-xs font-semibold whitespace-nowrap">
                ...
                <div className="flex flex-col items-center">
                  <div className="px-4 py-2.5 rounded-xl border border-blue-500/30 bg-blue-500/5 text-blue-300 text-xs font-semibold whitespace-nowrap">
                    Apple Juice Server
                  </div>
                  <p className="text-[10px] text-blue-400 mt-1">
                    Proxies request, no key stored
                  </p>
                </div>
                <div className="flex flex-col items-center mx-1">
                  <div className="flex items-center gap-0.5">
              ...
              <div className="mt-6 pt-5 border-t border-white/5 flex flex-wrap gap-5 text-[11px] text-[#8a8f98]">
                <span className="flex items-center gap-2">
                  <span className="inline-block w-3 h-3 rounded-sm bg-[#ccff00]/20 border border-[#ccff00]/40"></span>{" "}
                  Key never leaves your device
                </span>
                <span className="flex items-center gap-2">
                  <span className="inline-block w-3 h-3 rounded-sm bg-blue-500/20 border border-blue-500/40"></span>{" "}
                  Prompt proxied, not stored
                </span>
                <span className="flex items-center gap-2">
                  <span className="inline-block w-3 h-3 rounded-sm bg-red-500/20 border border-red-500/40"></span>{" "}
                  Server cannot see your key
                </span>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="mt-5">
              ...
              keystroke data, the content of scripts you generate, or any file
              contents from your Roblox Studio project.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              The Apple Juice plugin for Roblox Studio operates entirely within
              the Studio sandbox environment. Specifically, it:
            </p>
            <ul className="mt-5 space-y-3 list-none">
              {[
            ...
            <p className="mt-5">
              The pairing token is a short-lived random string generated per
              session. It is invalidated when you close your dashboard tab.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Session data is automatically deleted when your session expires.
              Credit balance records are retained for operational
              reconciliation. If you would like your data permanently deleted,
              contact us via the GitHub repository or Discord server and we will
          ...
          <section>
            ...
            <p>
              Apple Juice is not directed at children under 13. We do not
              knowingly collect personal information from children under 13. If
              you believe a child under 13 has provided us with personal
              information, please contact us and we will delete it promptly.
            </p>
            <p className="mt-4">
              Roblox operates its own age-verification and parental consent
              mechanisms as part of its OAuth flow. We rely on Roblox&apos;s
              authorization system and do not independently verify user age
              beyond what Roblox provides.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              page. Continued use of Apple Juice after changes are posted
          ...
          <section>
            ...
            <p>
              ...
              data deletion, please reach out via the GitHub repository or
              Discord server linked in the footer of the Apple Juice website.
            </p>
          </section>
        </div>
        ...
        <div className="pt-16 border-t border-white/5 mt-16 flex items-center justify-between">
          <a
            href="/"
            className="text-[#ccff00] hover:underline font-medium text-sm"
          >
            ← Back to Home
          </a>
