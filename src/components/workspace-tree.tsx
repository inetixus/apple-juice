...
const INSERTABLE_CATEGORIES = [
  {
    label: "Scripts",
    items: [
      { className: "Script", label: "Script" },
      { className: "LocalScript", label: "LocalScript" },
  ...
  },
  {
    label: "Parts",
    items: [
      { className: "Part", label: "Part" },
      { className: "MeshPart", label: "MeshPart" },
      { className: "SpawnLocation", label: "SpawnLocation" },
      { className: "Seat", label: "Seat" },
      { className: "VehicleSeat", label: "VehicleSeat" },
      { className: "TrussPart", label: "TrussPart" },
      { className: "WedgePart", label: "WedgePart" },
      { className: "CornerWedgePart", label: "CornerWedgePart" },
      { className: "UnionOperation", label: "Union" },
      { className: "NegateOperation", label: "Negate" },
    ],
  },
  {
    label: "Containers",
    items: [
      { className: "Model", label: "Model" },
      { className: "Folder", label: "Folder" },
      { className: "Configuration", label: "Configuration" },
      { className: "Actor", label: "Actor" },
    ],
  },
  {
    label: "Values",
    items: [
      { className: "StringValue", label: "StringValue" },
      { className: "NumberValue", label: "NumberValue" },
      { className: "IntValue", label: "IntValue" },
      { className: "BoolValue", label: "BoolValue" },
      { className: "CFrameValue", label: "CFrameValue" },
      { className: "Vector3Value", label: "Vector3Value" },
      { className: "Color3Value", label: "Color3Value" },
      { className: "BrickColorValue", label: "BrickColorValue" },
      { className: "ObjectValue", label: "ObjectValue" },
      { className: "RayValue", label: "RayValue" },
    ],
  },
  {
    label: "Interactions",
    items: [
      ...
      { className: "TouchTransmitter", label: "TouchTransmitter" },
  ...
  },
  {
    label: "GUI",
    items: [
      { className: "ScreenGui", label: "ScreenGui" },
      { className: "Frame", label: "Frame" },
      { className: "TextLabel", label: "TextLabel" },
      { className: "TextButton", label: "TextButton" },
      { className: "TextBox", label: "TextBox" },
      { className: "ImageLabel", label: "ImageLabel" },
      { className: "ImageButton", label: "ImageButton" },
      { className: "ScrollingFrame", label: "ScrollingFrame" },
      { className: "ViewportFrame", label: "ViewportFrame" },
      { className: "CanvasGroup", label: "CanvasGroup" },
      { className: "BillboardGui", label: "BillboardGui" },
      { className: "SurfaceGui", label: "SurfaceGui" },
  ...
  },
  {
    label: "UI Layout",
    items: [
      { className: "UIListLayout", label: "UIListLayout" },
      { className: "UIGridLayout", label: "UIGridLayout" },
      { className: "UIPadding", label: "UIPadding" },
      { className: "UICorner", label: "UICorner" },
      { className: "UIStroke", label: "UIStroke" },
      { className: "UIGradient", label: "UIGradient" },
      { className: "UIScale", label: "UIScale" },
      {
        className: "UIAspectRatioConstraint",
        label: "UIAspectRatioConstraint",
      },
      { className: "UISizeConstraint", label: "UISizeConstraint" },
      { className: "UITextSizeConstraint", label: "UITextSizeConstraint" },
      { className: "UITableLayout", label: "UITableLayout" },
      { className: "UIPageLayout", label: "UIPageLayout" },
  ...
  },
  {
    label: "Effects",
    items: [
      { className: "ParticleEmitter", label: "ParticleEmitter" },
      { className: "Fire", label: "Fire" },
      { className: "Smoke", label: "Smoke" },
      { className: "Sparkles", label: "Sparkles" },
      { className: "Beam", label: "Beam" },
      { className: "Trail", label: "Trail" },
      { className: "Highlight", label: "Highlight" },
      { className: "PointLight", label: "PointLight" },
      { className: "SpotLight", label: "SpotLight" },
      { className: "SurfaceLight", label: "SurfaceLight" },
      { className: "Explosion", label: "Explosion" },
      { className: "ForceField", label: "ForceField" },
    ],
  },
  {
    label: "Environmental",
    items: [
      { className: "Atmosphere", label: "Atmosphere" },
      { className: "Sky", label: "Sky" },
      { className: "Clouds", label: "Clouds" },
      { className: "BloomEffect", label: "Bloom" },
      { className: "BlurEffect", label: "Blur" },
      { className: "ColorCorrectionEffect", label: "ColorCorrection" },
      { className: "SunRaysEffect", label: "SunRays" },
      { className: "DepthOfFieldEffect", label: "DepthOfField" },
    ],
  },
  {
    label: "Physics Constraints",
    items: [
      { className: "Attachment", label: "Attachment" },
      { className: "Bone", label: "Bone" },
      { className: "WeldConstraint", label: "WeldConstraint" },
      { className: "Weld", label: "Weld" },
      { className: "Motor6D", label: "Motor6D" },
      ...
      { className: "RodConstraint", label: "RodConstraint" },
      { className: "CylindricalConstraint", label: "CylindricalConstraint" },
      { className: "PrismaticConstraint", label: "PrismaticConstraint" },
      { className: "UniversalConstraint", label: "UniversalConstraint" },
      { className: "SlidingBallConstraint", label: "SlidingBall" },
    ],
  },
  {
    label: "Physics Forces",
    items: [
      { className: "VectorForce", label: "VectorForce" },
      { className: "LinearVelocity", label: "LinearVelocity" },
      { className: "AngularVelocity", label: "AngularVelocity" },
      { className: "Torque", label: "Torque" },
      { className: "AlignPosition", label: "AlignPosition" },
      { className: "AlignOrientation", label: "AlignOrientation" },
    ],
  },
  {
    label: "Sound",
    items: [
      { className: "Sound", label: "Sound" },
      { className: "SoundGroup", label: "SoundGroup" },
      { className: "AudioPlayer", label: "AudioPlayer" },
      { className: "AudioEmitter", label: "AudioEmitter" },
      { className: "AudioListener", label: "AudioListener" },
      { className: "AudioAnalyzer", label: "AudioAnalyzer" },
    ],
  },
  {
    label: "Network",
    items: [
      { className: "RemoteEvent", label: "RemoteEvent" },
      { className: "RemoteFunction", label: "RemoteFunction" },
      { className: "BindableEvent", label: "BindableEvent" },
      { className: "BindableFunction", label: "BindableFunction" },
  ...
  },
  {
    label: "Animation",
    items: [
      { className: "Animation", label: "Animation" },
      { className: "Animator", label: "Animator" },
  ...
  },
  {
    label: "Avatar",
    items: [
      { className: "Humanoid", label: "Humanoid" },
      { className: "HumanoidDescription", label: "HumanoidDescription" },
      { className: "Accessory", label: "Accessory" },
      { className: "Shirt", label: "Shirt" },
      { className: "Pants", label: "Pants" },
      { className: "ShirtGraphic", label: "ShirtGraphic" },
...
function InsertObjectMenu({
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/40 backdrop-blur-[2px]">
      <div
        ref={menuRef}
        className="w-[320px] rounded border overflow-hidden animate-in fade-in zoom-in duration-150"
        style={{
          background: "#2d2d30",
          borderColor: "#454545",
      ...
      >
        <div
          ...
          style={{ borderBottom: "1px solid #454545", background: "#333333" }}
        >
        ...
        <div
          ...
          className="custom-scrollbar bg-[#252526]"
        >
            ...
            <div key={cat.label} className="mb-2 last:mb-0">
              ...
              {cat.items.map((item) => (
                <button
                  key={item.className}
                  onClick={() => {
                    onInsert(parentPath, item.className, item.label);
                    onClose();
                  }}
                  style={{
                    width: "100%",
                ...
                >
                  ...
                  >
                    <img
                      src={getIconPath(item.className)}
                      alt=""
                      width={16}
                      height={16}
    ...
    for (let i = 0; i < parts.length; i++) {
      ...
      if (!existing) {
        ...
        existing = {
          ...
          isFolder:
            !isLast ||
            (isLast && cleanType !== "" && CONTAINERS.has(cleanType)),
    ...
    <div style={{ position: "relative" }}>
      <div
        ...
        onClick={(e) => {
          ...
          // Trigger file click only if it's a script or file type (e.g., has standard code file extension or is a Roblox Script instance)
          const isScript =
            node.type === "Script" ||
            node.type === "LocalScript" ||
            node.type === "ModuleScript" ||
            (!node.isFolder && (
              node.type === "" ||
              node.type === "File" ||
              node.name.endsWith(".lua") ||
              node.name.endsWith(".luau") ||
        ...
        >
          {isExpandable && (
            ...
            >
              <path
                d="M1 1 L7 4 L1 7 Z"
                fill={hovered || isSelected ? "#ffffff" : "#9d9d9d"}
              />
            </svg>
          )}
        </div>
          ...
          <img
            ...
            onError={(e) => {
              ...
              if (!img.dataset.fallback) {
                ...
                img.src = "/roblox-icons/Part@2x.png";
              }
            }}
          />
        </div>
          ...
          >
            <svg width="14" height="14" viewBox="0 0 16 16">
              <circle
                ...
                r="7"
                fill="none"
                stroke={isSelected ? "#ffffff" : "#a0a0a0"}
                strokeWidth="1.5"
              />
              <line
                x1="8"
        ...
        {showContextMenu && (
          ...
          >
            ...
            <button
              ...
              onClick={() => {
                setShowContextMenu(false);
                if (onVault) onVault(node.fullPath);
              }}
            >
              Vault Item
            </button>
        ...
        >
          ...
          <input
            ...
            style={{
              ...
              padding: "2px 0",
              fontFamily:
                "'Source Sans Pro', 'Segoe UI', system-ui, sans-serif",
            }}
          />
          <button
